...
IDIR = /home/richard/code/librobotcontrol/library/include
...
beagle:
	rsync -r . debian@beaglebone:data-logger
	ssh debian@beaglebone "make -C data-logger"
